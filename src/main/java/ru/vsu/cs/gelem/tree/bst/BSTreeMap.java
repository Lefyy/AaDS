package ru.vsu.cs.gelem.tree.bst;

import java.util.Collection;
import java.util.Iterator;
import java.util.Map;
import java.util.Set;
import ru.vsu.cs.gelem.util.dummy.DefaultNotSupportedCollection;
import ru.vsu.cs.gelem.util.dummy.DefaultNotSupportedSet;
import ru.vsu.cs.gelem.util.dummy.DefaultNotSupportedSortedMap;
